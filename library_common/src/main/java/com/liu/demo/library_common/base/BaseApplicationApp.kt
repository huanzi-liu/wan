package com.liu.demo.library_common.base

import android.app.Application
import com.blankj.ALog
import com.liu.demo.library_common.BuildConfig
import java.util.ArrayList

abstract class BaseApplicationApp :Application() {
     companion object {
     ...
     private fun initALog(){
         ALog.init(this)// 设置 log 总开关，包括输出到控制台和文件，默认开
             ...
             .addFormatter(ALog.IFormatter<ArrayList<*>> { "ALog Formatter ArrayList { $it }" })
             .apply {
                 ALog.i(this)
             }
     }
